<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($name_bk['id_user'] === $id_user) {
            ...
            $query = "INSERT INTO name_bk(id_user,pass_user, name_bkc,address_bkc,tel_bkc, id_car,level_bkc)
                        VALUE ('$id_user' ,'$pass_userenc' , '$name_bkc', '$address_bkc','$tel_bkc', '$id_car', 'u')";
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                <div class="row mb-3 mt-3 fs-4">
                    ...
                    <input type="password" name="pass_user"class="form-control" placeholder="รหัสผ่าน" required>
                        ...
                        <div class="row mb-3 mt-3 fs-4">
                    <label for="name_bck" class="col-sm-2 col-form-label" >ชื่อพนักงาน</label>
                        <div class="col-sm-6">
                    <input type="text" name="name_bck" class="form-control" placeholder="ชื่อผู้จอง" required>
                            </div>
                            </div>
                     <div class="row mb-3 mt-3 fs-4">
                    <label for="name_car"class="col-sm-2 col-form-label">ชื่อยี่ห้อรถ</label>
                        <div class="col-sm-6">
                    <input type="text" name="name_car" class="form-control" placeholder="ชื่อยี่ห้อรถ" required>
                            </div>
                            </div>
                        <div class="row mb-3 mt-3 fs-4">
                    <label for="address_bkc"class="col-sm-2 col-form-label">ที่อยู่ผู้เช่ารถ</label>
                        <div class="col-sm-6">
                    <input type="text" name="address_bkc" class="form-control" placeholder="เวลาออก" required>
                            </div>
                            </div>
                            <div class="row mb-3 mt-3 fs-4">
